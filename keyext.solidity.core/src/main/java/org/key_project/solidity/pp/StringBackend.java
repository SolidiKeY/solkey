...
/// A [Backend] which appends all output to a StringBuffer. The [#mark(Objecto)] method
/// does nothing in this implementation. There is a method [#count()] which returns the number
/// of characters written by this so far. The method [#toString()] gets the output written so
/// far.
