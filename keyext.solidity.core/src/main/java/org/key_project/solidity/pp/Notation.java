...
public abstract class Notation {
    ...
    public static final class ModalityNotation extends Notation {
        ...
        public void print(Term t, LogicPrinter sp) {
            assert t.op() instanceof SModality;
            var mod = (SModality) t.op();
    ...
    public static final class Subst extends Notation {
        ...
        public void print(Term t, LogicPrinter sp) {
            ...
            final int assTarget =
                (t.sort() == SolidityDLTheory.FORMULA ? (t.sub(1).op() == Equality.EQUALS ? 75 : 60)
                        : 110);
    ...
    public static final class SchemaVariableNotation extends VariableNotation {
            ...
            if (v instanceof OperatorSV) {
                switch (v) {
                    ...
                    case SkolemTermSV skolemTermSV -> {
                        if (skolemTermSV.sort() == SolidityDLTheory.FORMULA) {
                ...
                boolean first = true;
                for (SModality.SolidityModalityKind modality : modalOperatorSV.getModalities()) {
                    if (!first) {
        ...
        public void print(Term t, LogicPrinter sp) {
            ...
            Object o = sp.getInstantiations()
                    .getInstantiation((SchemaVariable) (t.op()));
            if (o == null) {
