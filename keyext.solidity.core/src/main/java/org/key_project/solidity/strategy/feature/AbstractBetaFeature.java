...
public abstract class AbstractBetaFeature implements Feature {
    ...
    /// Get the information about a term
    ...
    public static boolean alwaysReplace(Term p_t) {
        return p_t.op() instanceof SModality || p_t.op() instanceof Quantifier;
    }

    /// @return true iff the formula p_t could be split using the beta rule
    ...
    /// Information about a term as cached within "betaCandidates"
    ...
    protected abstract RuleAppCost doComputation(PosInOccurrence pos,
            Term findTerm, ServiceCaches caches);
}
