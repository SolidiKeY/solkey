...
/// constraints to this one by unifying two terms and creating all necessary Metavariable - Term
/// pairs. There are no public constructors to build up a new Constraint use the BOTTOM constraint
/// of
...
public class EqualityConstraint implements Constraint {
    ...
    /// unsatisfiable Constraint would be built because of failed unification, cycle or s.th.
    /// similar
    ...
    private Term instantiate(Term p, Services services) {
        ConstraintAwareSyntacticalReplaceVisitor srVisitor =
            new ConstraintAwareSyntacticalReplaceVisitor(services, this, null,
                null, null);
    ...
    /// required.
    /// @return a constraint under which t0, t1 are equal modulo bound renaming. <code>this</code>
    /// is
    ...
    private Constraint unifyHelp(Term t0, Term t1,
    ...
    /// @return true iff this constraint is as weak as "co", i.e. every instantiation satisfying
    /// "co"
    /// also satisfies "this".
    @Override
    ...
    /// ONLY FOR TESTS DON'T USE THEM IN ANOTHER WAY
    ///
