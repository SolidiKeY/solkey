...
public class MonomialsSmallerThanFeature extends AbstractMonomialSmallerThanFeature {
    ...
    static TermFeature createHasCoeffTermFeature(final IntLDT numbers) {
    ...
    /// @return the degree of a monomial (number of terms that are connected multiplicatively) -1.
    /// To
