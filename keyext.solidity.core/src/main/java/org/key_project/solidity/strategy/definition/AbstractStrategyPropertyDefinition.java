...
/// key-value-pair in [StrategyProperties].
///
/// @author Martin Hentschel
/// @see OneOfStrategyPropertyDefinition
public class AbstractStrategyPropertyDefinition {
    ...
    /// Returns children which edits related properties to this. They might be shown different in
    /// the
    /// user interface.
    ///
