...
public class AssumesInstantiator {
    ...
    private final AssumesInstantiationCachePool.AssumesInstantiationCache assumesInstCache;
    ...
    private SolTaclet getTaclet() {
        return (SolTaclet) tacletAppContainer.getTacletApp().taclet();
    }
