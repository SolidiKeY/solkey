...
import org.key_project.solidity.strategy.definition.AbstractStrategyPropertyDefinition;
...
public class ModularSolidityDLStrategyFactory implements StrategyFactory {
    private final List<StrategyFactory> componentFactories = Arrays.asList(new FOLStrategyFactory(),
        new IntegerStrategyFactory(), new SymExStrategyFactory(),
        new SolidityDLStrategyFactory());

    /// The unique [Name] of this [StrategyFactory].
    public static final Name NAME = ModularSolidityDLStrategy.NAME;
    ...
    public ModularSolidityDLStrategyFactory() {
    }
    ...
    public Strategy<@NonNull Goal> create(Proof proof, StrategyProperties strategyProperties) {
        ...
        return new ModularSolidityDLStrategy(proof, componentStrategies, strategyProperties);
    }
