...
public class HandleArith {
    ...
    public static Term provedByArith(Term problem, Services services) {
        ...
        IntLDT integerLDT = services.getTheoryInfo().getIntLDT();
    ...
    /// Try to prove problem by know that axiom is true. The idea is that we know a>=b(axiom),we
    /// want
    ...
    /// Format literal to a form of "geq",linke a>=b;For example, a <=b to b>=a;a>b to
    /// a>=b+1;!(a>=b)
    /// to b>=a+1..
    ///
