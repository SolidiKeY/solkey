...
public class LexPathOrdering implements TermOrdering {
    ...
    private CompRes compareHelp2(Term p_a, Term p_b) {
        ...
        final int opComp =
            compare(p_a.op(), p_a.sort(), p_b.op(), p_b.sort());
        if (opComp == 0) {
    ...
    private static class LiteralWeighter extends Weighter {
        ...
        protected @Nullable Integer getWeight(Operator p_op) {
            ...
            if (p_op instanceof SFunction && (opStr.equals("TRUE") || opStr.equals("FALSE"))) {
                return 3;
            }
            return switch (opStr) {
    ...
    private static class FunctionWeighter extends Weighter {
        protected @Nullable Integer getWeight(Operator p_op) {
            ...
            if (p_op instanceof SFunction rf && rf.isUnique()) {
                return 5;
            }
