...
public class TermBuilder {
    ...
    public Term prog(SModality.SolidityModalityKind modKind, SolidityBlock jb, Term t) {
        return tf.createTerm(SModality.getModality(modKind, jb), new Term[] { t }, null);
    }

    public Term box(SolidityBlock jb, Term t) {
        return prog(SModality.SolidityModalityKind.BOX, jb, t);
    }

    public Term dia(SolidityBlock jb, Term t) {
        return prog(SModality.SolidityModalityKind.DIA, jb, t);
    }
