...
/// to be a subsort of the instantiations of the supersorts of this sort
...
public class GenericSort extends SortImpl {
    ...
    /// list of sorts this generic sort may be instantiated with; EMPTY\_SORT\_SORT means that every
    /// sort may be used
    ...
    /// @return true iff "p\_s" is subsort of every non-generic supersort of this sort
