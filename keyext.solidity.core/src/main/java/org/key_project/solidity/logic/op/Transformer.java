 ...
 */
public class Transformer extends SFunction {
    ...
    public Transformer(Name name, Sort argSort) {
        this(name, SolidityDLTheory.FORMULA, new ImmutableArray<>(argSort));
    }
     ...
     */
    public static Transformer getTransformer(Transformer t, Services services) {
