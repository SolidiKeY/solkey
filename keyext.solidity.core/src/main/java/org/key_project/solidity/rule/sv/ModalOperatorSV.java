...
public class ModalOperatorSV extends SModality.SolidityModalityKind implements SchemaVariable {
    ...
    private final ImmutableSet<SModality.SolidityModalityKind> modalities;
    ...
    ModalOperatorSV(Name name, ImmutableSet<SModality.SolidityModalityKind> modalityKinds) {
        super(name);
        this.modalities = modalityKinds;
    }

    /// returns an unmodifiable set of operators this schemavariable can match
    public ImmutableSet<SModality.SolidityModalityKind> getModalities() {
        return modalities;
    }
    ...
    public @NonNull Sort sort() {
        throw new UnsupportedOperationException("A SolidityModalityKind does not have a sort.");
    }
