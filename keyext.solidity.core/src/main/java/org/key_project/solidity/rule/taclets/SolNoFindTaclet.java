...
import org.key_project.solidity.rule.execution.NoFindTacletExecutor;
...
public class SolNoFindTaclet extends SolTaclet {
    ...
    public SolNoFindTaclet(Name name, TacletApplPart applPart,
