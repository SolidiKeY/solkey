...
///
/// The field's declared type is not restricted here; rules discriminate on it through the
/// `\hasFieldSort` / `\hasMemoryFieldSort` variable conditions, whose generic-sort bounds
/// reject unwanted instantiations (e.g. `alphaPrim \extends Prim` rejects reference-typed
/// fields, `alphaId \extends Identity` rejects value-typed ones).
