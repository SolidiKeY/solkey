...
public class Polynomial {
    ...
    /// @return <code>true</code> if the value of <code>this</code> will always be equal to the
    /// value
    ...
    /// @return <code>true</code> if the value of <code>this</code> will always be less or equal
    /// than
