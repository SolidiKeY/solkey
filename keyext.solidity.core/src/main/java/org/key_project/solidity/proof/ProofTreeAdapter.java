...
/// An abstract adapter class for receiving proof tree events. <code>proofStructureChanged</code>
/// has
...
public abstract class ProofTreeAdapter implements ProofTreeListener {
    ...
    /// traversed (e.g. in order to free the nodes in caches). The method proofPruned is called,
    /// when
