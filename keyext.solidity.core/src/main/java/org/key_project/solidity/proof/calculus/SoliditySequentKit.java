...
package org.key_project.solidity.proof.calculus;
...
public class SoliditySequentKit extends SequentKit {

    protected static SoliditySequentKit INSTANCE = new SoliditySequentKit();

    public static SoliditySequentKit getInstance() {
        if (INSTANCE == null) {
    ...
    protected SoliditySequentKit() {
        super();
    }

    @Override
    public Semisequent getEmptySemisequent() {
        return org.key_project.solidity.proof.calculus.Semisequent.EMPTY_SEMISEQUENT;
    }


    @Override
    public Sequent getEmptySequent() {
        return org.key_project.solidity.proof.calculus.Sequent.EMPTY_SEQUENT;
    }
    ...
    protected Sequent createSequent(Semisequent ante, Semisequent succ) {
        ...
        return new org.key_project.solidity.proof.calculus.Sequent(ante, succ);
    }

    @Override
    protected Semisequent createSemisequent(ImmutableList<SequentFormula> sequentFormulas) {
        return sequentFormulas.isEmpty()
                ? org.key_project.solidity.proof.calculus.Semisequent.EMPTY_SEMISEQUENT
                : new org.key_project.solidity.proof.calculus.Semisequent(sequentFormulas);
    }
