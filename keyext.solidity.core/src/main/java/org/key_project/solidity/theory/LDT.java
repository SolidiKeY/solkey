...
public abstract class LDT implements Named {
    ...
    public abstract boolean isResponsible(BinaryOperator op, Term[] subs,
            Services services);

    public abstract boolean isResponsible(BinaryOperator op, Term sub,
            Services services);

    public abstract boolean isResponsible(BinaryOperator op, Term left, Term right,
            Services services);
