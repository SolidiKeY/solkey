...
public class IncludeFinder extends AbstractBuilder<Void> {
    ...
    @Override
    public Void visitOne_include_statement(KeYSolidityDLParser.One_include_statementContext ctx) {
    ...
    @Override
    public Void visitOne_include(KeYSolidityDLParser.One_includeContext ctx) {
